...
class PhoneValidator extends CValidator {
    ...
    protected function validateAttribute($object, $attribute) {
        ...
        if (empty($object->$attribute)) {
            ...
            $translated_msg = Yii::t("PhoneValidator.general", $this->emptyMessage, array('{attribute}' => $attribute));
        ...
        $translated_msg = Yii::t("PhoneValidator.general", $this->message);
        $this->addError($object, $attribute, $translated_msg);
    }
    ...
    public function isValidateLenPhone($object, $attribute){
        ...
        $this->addError($object, $attribute, 'Не верный формат номер, например - необходимо указать номер в формате +7(921)0000000');
